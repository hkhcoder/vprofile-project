...
ALTER TABLE `user`
  ADD COLUMN `profileImg` varchar(255) DEFAULT NULL,
  ADD COLUMN `profileImgPath` varchar(255) DEFAULT NULL,
  ADD COLUMN `dateOfBirth` varchar(255) DEFAULT NULL,
  ...
  ADD COLUMN `permanentAddress` varchar(255) DEFAULT NULL,
  ADD COLUMN `tempAddress` varchar(255) DEFAULT NULL,
  ADD COLUMN `primaryOccupation` varchar(255) DEFAULT NULL,
  ADD COLUMN `secondaryOccupation` varchar(255) DEFAULT NULL,
  ADD COLUMN `skills` varchar(255) DEFAULT NULL,
  ADD COLUMN `phoneNumber` varchar(255) DEFAULT NULL,
  ADD COLUMN `secondaryPhoneNumber` varchar(255) DEFAULT NULL,
  ADD COLUMN `nationality` varchar(255) DEFAULT NULL,
  ADD COLUMN `language` varchar(255) DEFAULT NULL,
  ADD COLUMN `workingExperience` varchar(255) DEFAULT NULL;
